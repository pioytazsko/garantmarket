...
//$search = correctString($search);
//$search = iconv('utf-8', 'windows-1251', $search);
$search = addslashes($search);
$search = htmlspecialchars($search);
$search = stripslashes($search);
//$search=$corrector->parse($search);
...
//    if(    mb_check_encoding($searchKeywordArray,"UTF-8")){ echo "UTF/-8- searchkey<br>";}else {echo "NOT UTF<br>";};
//   
//    if(    mb_check_encoding($search,"UTF-8")){ echo "UTF/-8- search<br>";}else {echo "NOT UTF<br>";};
...
//         print_r($result);
       ...
       //
            ...
            $search=ltrim($search);
                        ...
                        echo '<div style="text-decoration:none;float:left;margin-top:10px;max-width:500px;text-align:left">';
                        echo    '<a style="margin:0 15px" href="/catalog/'.$result['chpu'].'/'.$sqlItem['chpu'].'">
                        ...
                        echo'    <div style="margin:0 15px;display:block;">
                                    <a style=" text-decoration:none;" href="/catalog/'.$result['chpu'].'/'.$sqlItem['chpu'].'">
                                        <span style="font-size:12px">Цена:'.$price.' бел.руб.</span>
