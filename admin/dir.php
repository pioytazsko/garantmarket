...
//    arsort($list);
    foreach($list as $file ){
     echo "<div class='fileblock'><input class='select_file' id='select' value='".$file."' type=\"checkbox\"><a target=\"_blank\" download=\"\" href='./files/$file'><div class='filename'>$file</div></div></a>";
