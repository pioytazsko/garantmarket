...
{
?>
				<li><a href="catalog/<?php if($shopcatrez['chpu']!='') echo $shopcatrez['chpu']."/"; else echo "element/"; ?>" title="<?php echo "$shopcatrez[name]"; ?>"><?php if($shopcatrez['h1']){ echo "$shopcatrez[h1]"; }else{ echo "$shopcatrez[name]"; } ?></a></li><div class="sep"><img src="image/sep_2.png"></div>
<?php 
}
